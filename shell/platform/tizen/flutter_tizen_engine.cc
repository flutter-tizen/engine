...
FlutterTizenEngine::FlutterTizenEngine(FlutterTizenEngine* main_engine,
                                       bool headed,
                                       void* win)
    : FlutterTizenEngine(headed, win) {
...
FlutterTizenEngine* FlutterTizenEngine::SpawnEngine(
  ...
  auto engine = std::make_unique<FlutterTizenEngine>(
      this, true, engine_properties.custom_win);
  if (!engine->RunSpawnedEngine(engine_properties)) {
